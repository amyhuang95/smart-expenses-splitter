    ...
    <section className="card" aria-label="Personal balance summary">
      <div className="card-body">
        <h3 className="h6 fw-bold mb-1">
          My Balance{" "}
          <HelpTooltip content="Your net balance across all unsettled expenses. Green = someone owes you. Red = you owe someone. When everyone marks paid, the expense auto-settles." />
        </h3>
        ...
        <div className="d-flex justify-content-between mb-3 pb-2 border-bottom">
          ...
          <div className="text-center">
            ...
            <span
              className={`fw-bold ${summary.net >= 0 ? "text-success" : "text-danger"}`}
            >
        ...
        {details.length === 0 ? (
          <div className="text-center py-2" role="status">
            <span className="badge bg-success fs-6 mb-1" aria-hidden="true">
              &#10003;
            </span>
